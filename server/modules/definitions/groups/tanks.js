...
// Bullets
Class.signalerBullet = {
    PARENT: "bullet",
    SIZE: 16,
    INDEPENDENT: true,
    SHAPE: "M 0 -1 C 0.5 0 0.5 0 0 1 C -0.25 1.5 -0.75 1.5 -0.5 1 C 0 0 0 0 -0.5 -1 C -0.75 -1.5 -0.25 -1.5 0 -1",
}
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic]),
                TYPE: ["multiBullet", { PERSISTS_AFTER_DEATH: true }],
                SHOOT_ON_DEATH: true,
            }
        },
        {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic]),
                TYPE: ["exponBullet", { PERSISTS_AFTER_DEATH: true }],
                SHOOT_ON_DEATH: true,
            }
        },
        {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic]),
                TYPE: ["splitBullet", { PERSISTS_AFTER_DEATH: true }],
                SHOOT_ON_DEATH: true,
            }
        },
        {
    ...
    GUNS: [
        {
            POSITION: [8, 10, 1, 0, 0, 40, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.annihilator, g.annihilator, g.annihilator]),
                TYPE: ["hive", { PERSISTS_AFTER_DEATH: true }],
                SHOOT_ON_DEATH: true,
            }
        },
        {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sig]),
                TYPE: "signalerBullet",
                LABEL: "Signal",
            }
        }
...
Class.saffron = {
    ...
    GUNS: [ {
        ...
        {
            POSITION: [ 5, 15, 1.1, 15, 0, 0, 0, ],
        }, 
    ],
};
Class.autogrow = makeAuto(Class.grow, "Auto-Grower")
Class.veg = {
    PARENT: "genericTank",
    LABEL: "Vegetables",
    GUNS: [{
        POSITION: [3, 10, 1.4, 22, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic]),
                TYPE: "growTrap",
                STAT_CALCULATOR: gunCalcNames.trap
...
// Twin Grower upgrades
Class.twinflankgrow = makeMulti({
    PARENT: "genericTank",
    GUNS: [ {
            POSITION: [ 22, 6, 1, 0, 5, 0, 0, ],
            PROPERTIES: {
...
Class.trigrow = {
    ...
    GUNS: [
        ...
        {
            POSITION: [ 5, 8, 1, 15, 0, 0, 0, ],
        }, 
    ],
};
Class.quadgrow = makeMulti({
    PARENT: "genericTank",
    GUNS: [ {
            POSITION: [ 22, 10, 1, 0, 0, 0, 0, ],
            PROPERTIES: {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, { speed: 1.2 }]),
                TYPE: "growBullet"
            }
        },
        {
        ...
        {
            POSITION: [3, 4.5, 1, 8, 7.25, 0, 0],
        },
        {
            POSITION: [3, 4.5, 1, 8, -7.25, 0, 0],
        },
        {
            POSITION: [3, 4.5, 1, 12, 3.75, 0, 0],
        },
        {
            POSITION: [3, 4.5, 1, 12, -3.75, 0, 0],
        }
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.multiplier]),
                TYPE: ["multiBullet", {MOTION_TYPE: "desmos"}]
            }
        },
        {
            POSITION: [14, 5, 1, 0, 0, 0, 0],
    ...
    GUNS: [
        {
            POSITION: [20, 8, 1, 0, 5.5, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.multiplier]),
                TYPE: "multiBullet"
            }
        },
        {
    ...
    GUNS: [
        {
            POSITION: [24, 8.5, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.multiplier]),
                TYPE: "multiBullet"
            }
        },
        {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.shotgun, {spread: 3}]),
                TYPE: "bullet",
            },
        },
        {
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, g.artillery, g.artillery]),
                TYPE: "bullet",
                LABEL: "Secondary",
            },
        },
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.desmos]),
                TYPE: ["bullet", {MOTION_TYPE: ["desmos", {amplitude: 15}]}]
            }
        },
        {
...
// Upgrade paths
Class.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "director", "pounder", "trapper", "desmos", "multi", "resist", "signaler", "grow"]
    ...
    Class.signaler.UPGRADES_TIER_2 = ["internet"]

    Class.grow.UPGRADES_TIER_2 = ["twingrow", "flankgrow", "garden", "plant", "coriander", "saffron", "veg"]
        Class.grow.UPGRADES_TIER_3 = ["autogrow"]

        Class.twingrow.UPGRADES_TIER_3 = ["trigrow", "twinflankgrow", "quadgrow", "weeder"]

        Class.flankgrow.UPGRADES_TIER_3 = ["twinflankgrow", "quadgrow"]

    Class.multi.UPGRADES_TIER_2 = ["expon", "split", "cali", "swirl", "doub",  "guarde", "infilt"]
        Class.multi.UPGRADES_TIER_3 = ["multiGuard"]
        Class.expon.UPGRADES_TIER_3 = ["tetra", "splitexpon", "teeantee"]
        Class.split.UPGRADES_TIER_3 = ["increas", "splitexpon"]

    Class.twin.UPGRADES_TIER_2 = ["doubleTwin", "tripleShot", "gunner", "hexaTank", "helix", "doub"]
    ...
    Class.sniper.UPGRADES_TIER_2 = ["assassin", "hunter", "minigun", "rifle", "infilt"]
    ...
    Class.flankGuard.UPGRADES_TIER_2 = ["hexaTank", "triAngle", "auto3", "trapGuard", "triTrapper", "guarde"]
    ...
    Class.pounder.UPGRADES_TIER_2 = ["destroyer", "builder", "artillery", "launcher", "volute", "expon", "definer"]
        Class.pounder.UPGRADES_TIER_3 = ["eagle"]
        Class.definer.UPGRADES_TIER_3 = ["shotgun", "buckshot", "prober", "teeantee"]
        Class.destroyer.UPGRADES_TIER_3 = ["conqueror", "annihilator", "hybrid", "construct", "tetra"]
        Class.artillery.UPGRADES_TIER_3 = ["mortar", "ordnance", "beekeeper", "fieldGun", "recurver"]
    ...
    Class.desmos.UPGRADES_TIER_2 = ["volute", "helix", "undertow", "hyper_desmos", "swirl"]
        ...
        Class.hyper_desmos.UPGRADES_TIER_3 = ["iterator", "duplicator"]