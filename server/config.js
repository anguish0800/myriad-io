const { chance } = require("./lib/random");
...
module.exports = {
    ...
    WINDOW_NAME: 'Myraid command',

    // Allows you to type and run javascript code in the terminal.
    REPL_WINDOW: false,

    // Welcome message once a player spawns.
    WELCOME_MESSAGE: "wsg dawg welcum in myriad.io.\n"
                    +"anyway follow the rules and join my discord server.\n"
                    +"anyway cya",
    ...
    FOOD_TYPES: [
        [4000, [
        [1024, 'egg'], [256, 'square'], [64, 'triangle'], [16, 'pentagon'], [4, 'betaPentagon'], [1, 'alphaPentagon'], [512, 'degg1'], [128, 'dsquare1'], [32, 'dtriangle1'], [8, 'dpentagon1'], [2, 'dbpentagon1'], [0.5, 'dapentagon1']
        ]],
        [0.05, [
        ...
        [0.0001, [
        [100000, 'sphere'], [10000, 'cube'], [1000, 'tetrahedron'], [100, 'octahedron'], [10, 'dodecahedron'], [1, 'icosahedron'], [0.0005, 'ushape']
        ]] 
    ],
    ...
    FOOD_TYPES_NEST: [
        [1, [
            [16, 'pentagon'], [ 4, 'betaPentagon'], [ 1, 'alphaPentagon'], [8, 'dpentagon1'], [2, 'dbpentagon1'], [0.5, 'dapentagon1']
        ]] //there isnt any nest in the test gamemode so no worries
    ],
    ...
    BOSS_TYPES: [{
        ...
        bosses: ["anguishboss"],
        amount: [1], chance: 0.5,
        message: "The anguisher is here, try as best as to not anger him...",
    },{
        bosses: ["anguishbossp2"],
        amount: [1], chance: 0.25,
        message: "The anguisher is here, and boy oh BOY he is Mad.",
    },{
        bosses: ["anguishbossp3"],
        amount: [1], chance: 0.125,
        message: "It's too late, The anguisher is LIVID.",
    }],
