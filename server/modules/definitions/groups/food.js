const { basePolygonDamage, basePolygonHealth, base, gunCalcNames } = require('../constants.js');
...
makeLaby = (type, level) => {
    ...
    return {
        ...
        BODY: {
            ...
            HEALTH: type.BODY.HEALTH * strenghtMultiplier+(strenghtMultiplier/5),
...
Class.ushape = {
    ...
    SIZE: 30,
    COLOR: "white",
    SHAPE: [[-1,-1],[0.5,-1],[1,-0.5],[1,0.5],[0.5,1],[-1,1],[-1.4,-1.2],[-0.2,1],[-1.4,-2],[-1,-0.6],[-1,0.4],[2,0.2],[0.2,-0.6],[1.4,-1],[-0.8,1.6],[0.8,1],[0.4,-0.4],[-0.6,-0.4],[1.8,0],[1,1.6],[0.2,-1.2],[1,0.8],[1,-0.8],[1.6,1.4],[1.8,1],[-1.6,-0.2],[-1.2,0.4],[-0.8,-1.6],[-1.4,1.8],[1.6,-1.6],[-1.8,1.6],[-1,-1.6],[0.4,-0.6],[-1.8,0.2],[-0.2,-0.2],[1.2,0.2],[0,-0.2],[-0.6,1],[-1.2,-1.4],[0.8,0.2],[-0.8,0.6],[0.2,-0.2],[-1.4,1.6],[2,-1],[1.8,0.8],[-1.2,-1.4],[-1.6,1.8],[-1.4,-1.4],[1.4,-1.2],[-0.2,0.4],[-1,-1.8],[-0.6,-0.4],[0.2,-1.8],[-0.8,1.8],[0.8,-1.4],[-0.2,-0.2],[-1,1.6],[1.8,-1.2],[1.6,0],[0.2,0.6],[-1.2,-0.6],[-1.6,0.6],[1.2,0.6],[0.2,0],[-0.8,0.2],[-1.4,-0.2],[1,2],[0,-0.4],[-1,-0.2],[-1.8,-1],[-1,0.4],[-0.8,-1.4],[-2,-0.8],[0.2,-1],[0.4,1.8],[1.6,-0.2],[-1,-0.6],[-0.6,-1.6],[-1.2,-1.8],[0.4,-0.8],[-1.6,1.2],[0.4,1.4],[0.8,-1.6],[0.8,-1.4],[-0.6,1.8],[-0.2,1.4],[-2,1.4],[-1.2,-0.6],[-1.6,0],[-1.6,-0.8],[0.6,-1.2],[-1,0.2],[1.2,0.6],[1.4,1],[-1,-0.4],[0.8,1.4],[-0.6,-0.4],[-1.8,0.6],[0,0.4],[-1,0.8],[-0.4,0.2],[1.6,-0.2],[1.4,0.8],[-0.6,1.2],[1.2,1.6],[1.8,0.8],[-1.4,1.6],[-0.4,-1],[-0.8,-1.4],[0.4,-1.2],[-1.2,1.6],[-1.4,-1.4],[1.4,-0.6],[0.6,-1.6],[-0.4,2],[-1.2,0.6],[0.2,1],[-1.4,0.2],[-0.6,-1],[0,0.4],[-1.2,-0.8],[-1,0.4],[0.2,0],[-0.2,0.6],[2,0.6],[-0.6,0.4],[1.2,-1.2],[1,-1.4],[-0.4,0.8],[1.4,-0.2],[-1.6,-0.4],[-0.8,-0.2],[-0.8,0.8],[1.6,-0.4],[1.6,-0.8],[1.6,-2],[-0.2,1.4],[-0.6,0.2],[-2,1.6],[0.8,0.8],[-1.2,0],[0.8,2],[1.8,-1.8],[-0.6,0.8],[0.6,-1.4],[-0.4,2],[-1.8,1.4],[-2,-0.2],[-0.4,-0.6],[-1.2,-0.4],[1.2,1.6],[-1.2,2],[1.2,0.6],[1,-1],[-0.8,-0.6],[0.6,-0.6],[0.6,2],[0.6,1.8],[-2,0.2],[0,0.4],[0.6,-1.2],[0.6,0.4],[-2,0.8],[-0.8,1.8],[-0.4,-1],[-0.2,1.2],[-1.2,-0.4],[-0.8,0.4],[-1.2,1.4],[-2,0.6],[0.6,-1.2],[-2,0.6],[1.8,0.4],[2,-0.8],[-1.6,-1.2],[-0.4,0.8],[1.8,1.6],[-1.8,0],[-1.2,0],[1.8,-0.2],[-1.8,-1.6],[1.8,0.6],[-0.4,1],[0.2,2],[-1.8,-1.4],[-1.8,-1.8],[1,0.2],[0.6,-2],[-2,-0.2],[-2,1],[-0.2,0.6],[-1,-1],[-1,1.4],[1,-1.4],[-0.6,2],[-0.4,0.2],[-0.2,-0.8],[-1.2,0.2]],
    BODY: {
        DAMAGE: 40,
        DENSITY: 80,
        HEALTH: 4000,
        PENETRATION: 100,
        ACCELERATION: 0.00314159
    },
    DRAW_HEALTH: true,
    GIVE_KILL_MESSAGE: true
};
    ...
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, {damage: base.VALUE * 2}]),
                TYPE: "bullet",
                AUTOFIRE: "TRUE"
            }
        }
...
}, 2, "Shadow Defensive Egg")
Class.rainbowdegg1 = makeMulti({
    PARENT: ["rainbowEgg"],
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 2, "Rainbow Defensive Egg")
Class.transdegg1 = makeMulti({
    PARENT: ["transEgg"],
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 2, "Transgender Defensive Egg")
Class.dgem1 = makeMulti({
    PARENT: ["gem"],
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 4, "Shiny Defensive Square")
Class.legendarydsquare1 = makeMulti({
    PARENT: ["legendarySquare"],
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 4, "Legendary Defensive Square")
Class.shadowdsquare1 = makeMulti({
    PARENT: ["shadowSquare"],
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 4, "Shadow Defensive Square")
Class.rainbowdsquare1 = makeMulti({
    PARENT: ["rainbowSquare"],
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 4, "Rainbow Defensive Square")
Class.transdsquare1 = makeMulti({
    PARENT: ["transSquare"],
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 4, "Transgender Defensive Square")
// TRIANGLES
Class.dtriangle1 = makeMulti({
    PARENT: "triangle",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 3, "Defensive Triangle", 180)
Class.shinydtriangle1 = makeMulti({
    PARENT: "shinyTriangle",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 3, "Shiny Defensive Triangle", 180)
Class.legendarydtriangle1 = makeMulti({
    PARENT: "legendaryTriangle",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 3, "Legendary Defensive Triangle", 180)
Class.shinydtriangle1 = makeMulti({
    PARENT: "shinyTriangle",
    VALUE: base.VALUE * 2,
    GUNS: [
...
Class.shadowdtriangle1 = makeMulti({
    PARENT: "shadowTriangle",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 3, "Shadow Defensive Triangle", 180)
Class.rainbowdtriangle1 = makeMulti({
    PARENT: "rainbowTriangle",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 3, "Rainbow Defensive Triangle", 180)
Class.transdtriangle1 = makeMulti({
    PARENT: "transTriangle",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 3, "Transgender Defensive Triangle", 180)
// PENTAGONS
Class.dpentagon1 = makeMulti({
    PARENT: "pentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 5, "Defensive Pentagon", 180)
Class.shinydpentagon1 = makeMulti({
    PARENT: "shinyPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Shiny Defensive Pentagon", 180)
Class.legendarydpentagon1 = makeMulti({
    PARENT: "legendaryPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Legendary Defensive Pentagon", 180)
Class.shadowdpentagon1 = makeMulti({
    PARENT: "shadowPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Shadow Defensive Pentagon", 180)
Class.rainbowdpentagon1 = makeMulti({
    PARENT: "rainbowPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Rainbow Defensive Pentagon", 180)
Class.transdpentagon1 = makeMulti({
    PARENT: "transPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Trans Defensive Pentagon", 180)
// BETA PENTAGONS
Class.dbpentagon1 = makeMulti({
    PARENT: "betaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 5, "Defensive Beta Pentagon", 180)
Class.shinydbpentagon1 = makeMulti({
    PARENT: "shinyBetaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Shiny Defensive Beta Pentagon", 180)
Class.legendarydbpentagon1 = makeMulti({
    PARENT: "legendaryBetaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Legendary Defensive Beta Pentagon", 180)
Class.shadowdbpentagon1 = makeMulti({
    PARENT: "shadowBetaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Shadow Defensive Beta Pentagon", 180)
Class.rainbowdbpentagon1 = makeMulti({
    PARENT: "rainbowBetaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Rainbow Defensive Beta Pentagon", 180)
Class.transdbpentagon1 = makeMulti({
    PARENT: "transBetaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Transgender Defensive Beta Pentagon", 180)
// ALPHA PENTAGONS
Class.dapentagon1 = makeMulti({
...
}, 5, "Defensive Alpha Pentagon", 180)
Class.shinydapentagon1 = makeMulti({
    PARENT: "shinyAlphaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Shiny Defensive Alpha Pentagon", 180),
Class.legendarydapentagon1 = makeMulti({
    PARENT: "legendaryAlphaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Legendary Defensive Alpha Pentagon", 180)
Class.shadowdapentagon1 = makeMulti({
    PARENT: "shadowAlphaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Shadow Defensive Alpha Pentagon", 180)
Class.rainbowdapentagon1 = makeMulti({
    PARENT: "rainbowAlphaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Rainbow Defensive Alpha Pentagon", 180)
Class.transdapentagon1 = makeMulti({
    PARENT: "transAlphaPentagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 5, "Transgender Defensive Alpha Pentagon", 180)
// HEXAGONS
Class.dhexagon1 = makeMulti({
    PARENT: "hexagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
Class.shinydhexagon1 = makeMulti({
    PARENT: "shinyHexagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
...
}, 6, "Shiny Defensive Hexagon")
Class.legendarydhexagon1 = makeMulti({
    PARENT: "legendaryHexagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 6, "Legendary Defensive Hexagon")
Class.shadowdhexagon1 = makeMulti({
    PARENT: "shadowHexagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 6, "Shadow Defensive Hexagon")
Class.rainbowdhexagon1 = makeMulti({
    PARENT: "rainbowHexagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
            POSITION: [18, 8, 1, 0, 0, 0, 0],
...
}, 6, "Rainbow Defensive Hexagon")
Class.transdhexagon1 = makeMulti({
    PARENT: "transHexagon",
    VALUE: base.VALUE * 2,
    GUNS: [
        {
