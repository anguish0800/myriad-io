...
Class.forsakenerOfficialV2 = {
	PARENT: ["genericSquarenought"],
	LABEL: "Forsakener",
	GUNS: [],
}
for (let i = 0; i < 4; i++) {
	Class.forsakenerOfficialV2.GUNS.push(
		{
			POSITION: [14, 2.5, 1, 0, 2, 90*i+10, 0],
			PROPERTIES: {
		...
		{
			POSITION: [14, 2.5, 1, 0, -2, 90*i-10, 0.5],
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, g.artillery]),
				TYPE: "bullet",
			},
...
Class.godforesakenerOfficialV2 = {
	PARENT: ["genericTrinought"],
	LABEL: "Godforesakener",
	GUNS: [],
}
for (let i = 0; i < 3; i++) {
	Class.godforesakenerOfficialV2.GUNS.push(
		{
			POSITION: [12, 1.5, 1, 0, -5, 120*i-10, 0.75],
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, {reload: 0.8, damage: 2}]),
				TYPE: "bullet",
			},
		},
		{
			POSITION: [12, 1.5, 1, 0, 5, 120*i+10, 1],
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, {reload: 0.8, damage: 2}]),
				TYPE: "bullet",
			},
		...
		{
			POSITION: [15, 2.5, 1, 0, -4, 120*i-5, 0.25],
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, {reload: 0.8, damage: 2}]),
				TYPE: "bullet",
			},
		...
		{
			POSITION: [15, 2.5, 1, 0, 4, 120*i+5, 0.5],
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, {reload: 0.8, damage: 2}]),
				TYPE: "bullet",
			},
		},
		{
			...
			PROPERTIES: {
				SHOOT_SETTINGS: combineStats([g.basic, g.artillery, {reload: 0.8}]),
				TYPE: "bullet",
			},
		},
	)
...
Class.addons.UPGRADES_TIER_0.push("dreadOfficialV2");
	...
	Class.dreadWeaponOfficialV2.UPGRADES_TIER_0 = ["swordOfficialV2", "pacifierOfficialV2", "peacekeeperOfficialV2", "invaderOfficialV2", "centaurOfficialV2"];
		...
		Class.peacekeeperOfficialV2.UPGRADES_TIER_0 = ["enforcerOfficialV2", "executorOfficialV2", "forsakenerOfficialV2"];
			...
			Class.forsakenerOfficialV2.UPGRADES_TIER_0 = ["godforesakenerOfficialV2"];
