const { combineStats, skillSet, makeAuto, addAura, LayeredBoss, makeDeco, makeMulti } = require('../facilitators.js');
...
// Developer Bosses
// the
Class.osamabinladenskull = {
    PARENT: "genericTank",
    MIRROR_MASTER_ANGLE: true,
    SHAPE: 'M -1 0 C -1 -1.3 1 -1.3 1 0 L 0.9 0.6 L 1 0.8 L 0.8 0.9 L 0.6 0.8 L 0.4 1.1 L 0.5 1.3 L -0.5 1.3 L -0.4 1.1 L -0.6 0.8 L -0.8 0.9 L -1 0.8 L -0.9 0.6 L -1 0 M -0.4 1.3 L -0.3 1.1 M -0.2 1.3 L -0.2 1.1 M 0 1.3 L 0 1.1 M 0.2 1.3 L 0.2 1.1 M 0.4 1.3 L 0.3 1.1 M -0.1 0.4 L -0.2 0.8 L -0.1 0.9 L 0 0.8 L 0.1 0.9 L 0.2 0.8 L 0.1 0.4 L 0 0.3 L -0.1 0.4 M 0 0.3 L 0 0.8 M -0.5 0 C -1.1 0.1 -0.9 0.6 -0.7 0.6 C -0.5 0.6 0.2 0.4 -0.5 0 M 0.7 0.6 C 0.9 0.6 1.1 0.1 0.5 0 C -0.2 0.4 0.5 0.6 0.7 0.6'
}
Class.osamabinladenmissile = {
    PARENT: "bullet",
    LABEL: "Bomb",
    SHAPE: 'M 1 -1 Q -1 -1 -0.8 -0.4 L -1 -1 L -2 -1 L -2 1 L -1 1 L -0.8 0.4 Q -1 1 1 1 Q 5 0 1 -1',
    GUNS: [
        ...Array(32).fill().map((_, i)=>({ // god bless you taureon for this
...
Class.osamabinladenfire2 = {
    PARENT: "genericTank",
    MIRROR_MASTER_ANGLE: true,
    SHAPE: 'M 0 0.5 C 1.4 0.6 1.4 -0.6 0 -0.5 L -1.1 -0.3 L -0.4 -0.2 L -0.9 -0.2 L -0.4 0.1 L -1 0.3 L 0 0.5',
    COLOR: 'red'
}
Class.osamabinladenfire = {
    PARENT: "genericTank",
    MIRROR_MASTER_ANGLE: true,
    SHAPE: 'M 0 1 C 2 1 2 -1 0 -1 L -2.1 -0.4 L -0.2 -0.6 L -1.9 -0.2 L -0.7 0.4 L -2.2 0.4 L 0 1',
    COLOR: 'orange',
    GUNS: [
        {
            POSITION: [1, 1, 1, 0, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, {reload: 0.075, damage: 1, recoil:1, shudder: 0.5, range: 0.1}]),
                TYPE: ["bullet",  { ALPHA: 0.5, COLOR: "orange" }],
                AUTOFIRE: true
            }
        },
        {
            POSITION: [1, 1, 1, 0, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, {reload: 0.075, damage: 1.5, recoil:1.5, shudder: 0.5, range: 0.1}]),
                TYPE: ["bullet",  { ALPHA: 0.5, COLOR: "orange" }],
                AUTOFIRE: true
            }
        },
        {
            POSITION: [1, 1, 1.5, 0, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, {reload: 0.075, damage: 2, recoil: 2, shudder: 0.5, range: 0.1}]),
                TYPE: ["bullet",  { ALPHA: 0.5, COLOR: "orange" }],
                AUTOFIRE: true
            }
        }
    ...
    TURRETS: [
        {
            ...
            TYPE: "osamabinladenfire2"
        }
    ]
}
Class.osamabinladenthruster = {
    PARENT: "genericTank",
    SHAPE: "M -1 1 L 1 0 L -1 -1 L -0.7 0 L -1 1",
    MIRROR_MASTER_ANGLE: true,
    COLOR: 'pink',
    GUNS: [
        {
            POSITION: [6, 6, -2.3, 6, 0, 180, 0]
        }
    ],
    TURRETS: [
        {
            POSITION: [6.5, -20, 0, 0, 0, 1],
            TYPE: "osamabinladenfire"
        }
    ]
}
Class.osamabinladenwindowshine = {
    PARENT: "genericTank",
    MIRROR_MASTER_ANGLE: true,
    SHAPE: 'M -0.05 -0.8 L -0.35 0.8 L -0.05 0.8 L 0.25 -0.8 L -0.05 -0.8 M 0.05 0.8 L 0.35 -0.8 L 0.45 -0.8 L 0.15 0.8 L 0.05 0.8',
    COLOR: '#FFFFFF'
}
Class.osamabinladenwindow2 = {
    PARENT: "genericTank",
    MIRROR_MASTER_ANGLE: true,
    SHAPE: 'M -1 -0.8 L 0.3 -0.8 L 0.8 0 L 0.3 0.8 L -1 0.8 L -0.8 0 L -1 -0.8',
    COLOR: '#B3FDF7',
    TURRETS: [
        {
            POSITION: [20, -3, 0, 0, 0, 1],
            TYPE: "osamabinladenwindowshine"
        }
    ]
}
Class.osamabinladenwindow1 = {
    PARENT: "genericTank",
    SHAPE: 'M -1 -0.8 L 0.3 -0.8 L 1.2 0 L 0.3 0.8 L -1 0.8 L -0.5 0 L -1 -0.8',
    MIRROR_MASTER_ANGLE: true,
    COLOR: '#B3FDF7',
    TURRETS: [
        {
            POSITION: [20, -1.5, 0, 0, 0, 1],
            TYPE: "osamabinladenwindowshine"
        }
    ]
}
Class.osamabinladen = {
    PARENT: "miniboss",
    LABEL: "Bomber",
    SHAPE: 'M 3 0 L 2 -1 L -2 -1 L -4 -2 L -3 0 L -4 2 L -2 1 L 2 1 L 3 0',
    ...
    GUNS: [
        {
            POSITION: [40, 10, 1, 0, 0, 73, 0]
        },
        {
            POSITION: [40, 10, 1, 0, 0, -73, 0]
        },
        {
            POSITION: [16, 9, -2, 0, 0, 180, 0]
        },
        {
            POSITION: [35, 9, 1, 0, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.destroyer, g.annihilator]),
                TYPE: "osamabinladenmissile"
            }
        },
    ],
    TURRETS: [
        {
            POSITION: [24, 15, 0, 0, 0, 1],
            TYPE: "osamabinladenwindow1"
        },
        {
            POSITION: [24, -3, 0, 0, 0, 1],
            TYPE: "osamabinladenwindow2"
        },
        {
            POSITION: [24, 10, 35, 0, 0, 1],
            TYPE: "osamabinladenthruster"
        },
        {
            POSITION: [24, 10, -35, 0, 0, 1],
            TYPE: "osamabinladenthruster"
        ...
        {
        POSITION: [18, -50, 0, 0, 180, 1],
            TYPE: "osamabinladenskull"
        }
    ]
}
// ram fr rfrf rf frrf rf rf fr frfrrf  rf  f  fr rf rf rf rf   rf fr  frf rfrfrrf frrf rffrf r rfr ffr r frrf rf rfrf f rf rfr frfrf rfrf rfrfrfrrff f rffrf rfrfrf rfrf rf rffrfrf rfrffrrffrrfrf rfrrfrrfrfrrfrrfrfrfrffrrfrfrffrfrrfrf rfrf rfrf rf frrfrf rf rf rf rfrf
Class.ramboss = {
    PARENT: "miniboss",
    LABEL: "Ram",
    SIZE: 45,
    UPGRADE_TOOLTIP: "\"the master of rams came\n" +
    "and they are LIVID\"",
    COLOR: "brown",
    SHAPE: "M -2 -1 C -1 -2 -0 -2 1 -1 L -1 -1 L 2 -0 L -1 1 L 1 1 C 0 2 -1 2 -2 1 Z",
    DRAW_HEALTH: true,
    FACING_TYPE: "smoothToTarget",
    MAX_CHILDREN: 25,
    GUNS: [
        {
            POSITION: [18, 10, 1.5, 15, 0, 180, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.factory, g.reloadsomemuch]),
                TYPE: "ram",
                STAT_CALCULATOR: gunCalcNames.drone,
                AUTOFIRE: true,
                SYNCS_SKILLS: true,
...
// teh angushier ffrrrgrrgfrffrfrffrfrff phas wan
Class.abmturret = {
    PARENT: "genericTank",
    COLOR: "grey",
    LABEL: "Multiplier turret",
    CONTROLLERS: ["nearestDifferentMaster", "onlyAcceptInArc"],
    INDEPENDENT: true,
    GUNS: [
        {
...
Class.abthrustturret = {
    PARENT: "genericTank",
    COLOR: "grey",
    LABEL: "Thrust- wait how did you die to it? it does 0 damage?",
    MIRROR_MASTER_ANGLE: true,
    GUNS: [
        {
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, g.abtt, {reload: 0.2, recoil: 1.5}]),
...
Class.anguishboss = {
    ...
    TEAM: TEAM_ENEMIES,
    SIZE: 20,
    UPGRADE_TOOLTIP: "\"do not anger him\n" +
    "OR E L S E\"",
    SHAPE: "M -1 0 L 0 1 Q 1 1 2 -0 Q 1 -1 -0 -1 L -1 0",
    COLOR: '#097d1a',
    FACING_TYPE: "smoothToTarget",
    GUNS: [
    {
        POSITION: [15, 4, 1, 0, 5-6, R, 0],
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, {recoil: 0.25}]),
            TYPE: "bullet"
        },
    },
    {
        POSITION: [15, 4, 1, 0, 5+6, -R, 1/6],
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, {recoil: 0.25}]),
            TYPE: "bullet"
        },
...
// teh angushier ffrrrgrrgfrffrfrffrfrff phas too
Class.abeturret = {
    PARENT: "genericTank",
    COLOR: "grey",
    LABEL: "Exponential turret",
    CONTROLLERS: ["nearestDifferentMaster", "onlyAcceptInArc"],
    INDEPENDENT: true,
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.multiplier]),
                TYPE: ["exponBullet"]
            }
        },
        {
...
Class.abfgturret = makeMulti({
    PARENT: "genericTank",
    COLOR: "grey",
    LABEL: "Flank guard turret",
    CONTROLLERS: ["nearestDifferentMaster", "onlyAcceptInArc"],
    INDEPENDENT: true,
    BODY: {
...
}, 3, "Flank Guard turret")
Class.abthrustturrett2 = {
    PARENT: "genericTank",
    COLOR: "grey",
    LABEL: "Upgraded Thrust- wait how did you die to it? it does 0 damage?",
    MIRROR_MASTER_ANGLE: true,
    GUNS: [
        {
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, g.abtt, {reload: 0.6, recoil:1.5}]),
                TYPE: ["bullet",  { ALPHA: 0.5 }],
                AUTOFIRE: true
            }
        },
        {
            POSITION: [18, 10, 1.5, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, g.abtt, {reload: 0.3, recoil: 2}]),
                TYPE: ["bullet",  { ALPHA: 0.5 }],
                AUTOFIRE: true
            }
        }
...
Class.anguishbossp2 = {
    ...
    TEAM: TEAM_ENEMIES,
    SIZE: 20,
    UPGRADE_TOOLTIP: "\"HE IS LIVID...\n" +
    "YOU FUCKED UP!\"",
    SHAPE: "M -2 0 L -1 2 Q 2 2 3 0 Q 2 -2 -1 -2 L -2 0",
    COLOR: '#097d1a',
    FACING_TYPE: "smoothToTarget",
    BODY: {
    ...
    GUNS: [
            ...
            {
                POSITION: [6, 13, 0.7, 15, Offx, R, 0],
                PROPERTIES: {
                TYPE: "swarm",
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.commander, {health: 3}]),
                STAT_CALCULATOR: gunCalcNames.swarm,
                },
            },
            {
                POSITION: [6, 13, 0.7, 15, Offx, -R, 0.25],
                PROPERTIES: {
                TYPE: "swarm",
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.commander, {health: 3}]),
                STAT_CALCULATOR: gunCalcNames.swarm,
            ...
            {
                POSITION: [6, 13, 0.7, 15, -Offx, R, 0.5],
                PROPERTIES: {
                TYPE: "swarm",
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.commander, {health: 3}]),
                STAT_CALCULATOR: gunCalcNames.swarm,
            ...
            {
                POSITION: [6, 13, 0.7, 15, -Offx, -R, 0.75],
                PROPERTIES: {
                TYPE: "swarm",
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.commander, {health: 3}]),
                STAT_CALCULATOR: gunCalcNames.swarm,
    ...
    {
        POSITION: [13, 15, 12, 180, 0, 0],
        TYPE: "abthrustturrett2"
    },
    {
        POSITION: [13, 15, -12, 180, 0, 0],
        TYPE: "abthrustturrett2"
...
//uh oh he mad uh he gonna kiell you're
Class.abtturret = {
    PARENT: "autoTankGun",
    COLOR: "grey",
    LABEL: "Tetration turret",
    CONTROLLERS: ["nearestDifferentMaster", "onlyAcceptInArc"],
    INDEPENDENT: true,
    GUNS: [
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.destroyer, g.multiplier]),
                TYPE: ["tetraBullet"]
            }
        },
        {
...
Class.abthrustturrett3 = {
    PARENT: "genericTank",
    COLOR: "grey",
    LABEL: "Mega Upgraded Thruster turret",
    MIRROR_MASTER_ANGLE: true,
    GUNS: [
        {
        ...
        },
        {
            POSITION: [22, 8, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, {reload: 0.6, damage: 1, recoil:1, shudder: 0.5}]),
                TYPE: ["bullet",  { ALPHA: 0.5, COLOR: "orange" }],
                AUTOFIRE: true
            }
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, {reload: 0.6, damage: 1.5, recoil:1.5, shudder: 0.5}]),
                TYPE: ["bullet",  { ALPHA: 0.5, COLOR: "orange" }],
                AUTOFIRE: true
            }
        },
        {
            POSITION: [18, 10, 1.5, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun, g.thruster, {reload: 0.3, damage: 2, recoil: 2, shudder: 0.5}]),
                TYPE: ["bullet",  { ALPHA: 0.5, COLOR: "orange" }],
                AUTOFIRE: true
            }
        }
...
Class.anguishbossp3 = {
    ...
    TEAM: TEAM_ENEMIES,
    SIZE: 20,
    UPGRADE_TOOLTIP: "\"too late\n" +
    "you're gone\"",
    SHAPE: "M -2 0 L -1 3 Q 4 3 5 0 Q 4 -3 -1 -3 L -2 0",
    COLOR: '#097d1a',
    FACING_TYPE: "smoothToTarget",
    BODY: {
        HEALTH: base.HEALTH * 2,
    ...
    GUNS: [
        {
            POSITION: [28, 10, 1, Offy, 0, 0, 0.25],
            PROPERTIES: {
        ...
        {
            POSITION: [26, 12, 1, Offy, 0, 0, 0.75],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.pelleter, g.lowPower, g.machineGun, { recoil: 1.15 }]),
                TYPE: "bullet",
            },
        ...
        {
            POSITION: [12, 15, 1.4, Offy+8, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.machineGun]),
                TYPE: "bullet",
            },
        ...
        {
            POSITION: [8, 20, 1, Offy-6, 0, R2, 0],
        },
        {
            POSITION: [8, 24, 0.9, Offy-8, 0, R2, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.skimmer, { reload: 4 }]),
                TYPE: ["abmissile", {SIZE: 0.75}],
            }
        },
        {
            POSITION: [8, 20, 1, Offy-6, 0, -R2, 0],
        ...
        {
            POSITION: [8, 24, 0.9, Offy-8, 0, -R2, 0.5],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.skimmer, { reload: 4 }]),
                TYPE: ["abmissile", {SIZE: 0.75}],
            }
    ...
    TURRETS: [
        {
            POSITION: [27, 16, -16, 180, 0, 0],
            TYPE: "abthrustturrett3"
        },
        {
            POSITION: [27, 16, 16, 180, 0, 0],
            TYPE: "abthrustturrett3"
        ...
        {
            POSITION: [6, 23, -13, 0, 90, 1],
            TYPE: "abmissilecturret"
        },
        {
            POSITION: [6, 23, 13, 0, 90, 1],
            TYPE: "abmissilecturret"
        ...
        {
            POSITION: [13, 0, 0, 0, 90, 1],
            TYPE: "abfturret"
        },
        {
            POSITION: [13, 32, 0, 0, 90, 1],
            TYPE: "abcturret"
        },
    ]
}
