...
var gameDraw = {
    ...
    reanimateColors: () => {
        ...
        gameDraw.animatedColor.green_teal = blinker ? gameDraw.color.green : gameDraw.color.teal;
    },
    animatedColors: {
        // police
        20: true,
    ...
    getColor: (colorNumber) => {
        switch (colorNumber) {
            ...
            case "tree":
                return "#267524";
            case "42":
            case "animatedGreenTeal":
                return gameDraw.animatedColor.green_teal;
        }
    },
