...
Class.diminisherOfficialV1 = {
	PARENT: ["genericDreadnought1"],
	LABEL: "Diminisher",
	UPGRADE_TOOLTIP: "Splitting Bullets",
	GUNS: [],
}
for (let i = 0; i < 3; i++) {
	Class.diminisherOfficialV1.GUNS.push({
		POSITION: [15, 7, 1, 0, 0, 120*i, 0],
		PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.basic, g.pounder, { reload: 0.75 }]),
			TYPE: "multiBullet"
...
// T2
Class.macheteOfficialV1 = {
	PARENT: ["genericDreadnought1"],
	LABEL: "Machete",
	UPGRADE_TOOLTIP: "Minigun",
	GUNS: [],
}
for (let i = 0; i < 3; i++) {
	Class.macheteOfficialV1.GUNS.push(
	{
		POSITION: [16, 7, 1, 4, 0, 120*i, 0],
		PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.minigun, { reload: 0.75 }]),
			TYPE: "bullet"
		}
	},
	{
		POSITION: [16, 7, 1, 2, 0, 120*i, 0.333],
		PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.minigun, { reload: 0.75 }]),
			TYPE: "bullet"
		}
	...
	{
		POSITION: [16, 7, 1, 0, 0, 120*i, 0.666],
		PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.minigun, { reload: 0.75 }]),
			TYPE: "bullet"
		}
...
Class.declinerOfficialV1 = {
	PARENT: ["genericDreadnought1"],
	LABEL: "Decliner",
	UPGRADE_TOOLTIP: "Big Splitting Bullets",
	GUNS: [],
}
for (let i = 0; i < 3; i++) {
	Class.declinerOfficialV1.GUNS.push({
		POSITION: [15, 9, 1, 0, 0, 120*i, 0],
		PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.destroyer, { reload: 0.75 }]),
			TYPE: "exponBullet"
		}
	},
	{
		POSITION: [13, 5, 1, 0, 0, 120*i, 0],
		PROPERTIES: {
			COLOR: 12
		}
	},
	{
		POSITION: [12, 6, 1, 0, 0, 120*i, 0],
		PROPERTIES: {
			COLOR: 12
		}
	});
}
Class.removerOfficialV1 = {
	PARENT: ["genericDreadnought1"],
	LABEL: "Remover",
	UPGRADE_TOOLTIP: "Spamming Splitting Bullets",
	GUNS: [],
}
for (let i = 0; i < 3; i++) {
	Class.removerOfficialV1.GUNS.push({
		POSITION: [15, 3, 1, 0, -2.2, 120*i, 0],
		PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.twin, { reload: 0.75 }]),
			TYPE: "multiBullet"
		}
	},
	{
		POSITION: [12, 1, 1, 0, -2.2, 120*i, 0],
		PROPERTIES: {
			COLOR: 12
		}
	},
	{
		POSITION: [15, 3, 1, 0, 2.2, 120*i, 0.5],
		PROPERTIES: {
			SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.twin, { reload: 0.75 }]),
			TYPE: "multiBullet"
		}
...
Class.addons.UPGRADES_TIER_0.push("dreadOfficialV1");
	Class.dreadOfficialV1.UPGRADES_TIER_1 = ["swordOfficialV1", "pacifierOfficialV1", "diminisherOfficialV1", "invaderOfficialV1", "centaurOfficialV1"];
		Class.swordOfficialV1.UPGRADES_TIER_M1 = ["sabreOfficialV1", "gladiusOfficialV1", "macheteOfficialV1"];
		Class.pacifierOfficialV1.UPGRADES_TIER_M1 = ["appeaserOfficialV1", "peacekeeperOfficialV1", "diplomatOfficialV1"];
		Class.diminisherOfficialV1.UPGRADES_TIER_M1 = ["declinerOfficialV1", "removerOfficialV1"]
...
for (let primary of Class.dreadOfficialV1.UPGRADES_TIER_1) {
	...
	for (let secondary of [ "swordOfficialV1", "pacifierOfficialV1", "diminisherOfficialV1", "invaderOfficialV1", "centaurOfficialV1", "medicareOfficialV1", "automationOfficialV1", "juggernautOfficialV1" ]) {
